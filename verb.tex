...
\\ \\
\par{For the \textit{present perfect} tense, we generally use the verb \textit{hebben (to
...
\\
\par{The pluperfect uses the \textit{simple past} tense of the verbs
\textit{hebben} and \textit{zijn}.}
\\
\begin{tabular}[t]{l l}
    \textit{Conjugation} \\
    \hline
    \textit{Ik} + \textit{had/was} + p.p. & \textit{We} + \textit{hadden/waren} + \textit{p.p.} \\
    \textit{Je} + \textit{had/was} + p.p. & \textit{Jullie} + \textit{hadden/waren} + \textit{p.p.} \\
    \textit{Hij} + \textit{had/was} + p.p. & \textit{Ze} + \textit{hadden/waren} + \textit{p.p.} \\
\end{tabular}
\\ \\
Using pluperfect
...
\\ \\
%------------------------------------------------------------------
% Section: Simple Perfect
%------------------------------------------------------------------
\sectionhead{Simple Perfect}
\par{For the future tense we use the auxiliary verb \textit{zullen (will)}} \\
\begin{tabular}[t]{l l}
    \textit{Conjugation} \\
    \hline
